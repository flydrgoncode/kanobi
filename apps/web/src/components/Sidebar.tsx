  ...
  return (
    <aside className="w-64 bg-bg-base flex flex-col h-screen shrink-0 border-r border-border-subtle">
      ...
      <div className="p-8 flex items-center gap-3">
        <div className="w-8 h-8 bg-bg-inverse flex items-center justify-center shrink-0 ring-1 ring-border-subtle">
      ...
      <div className="p-6">
        <div className="px-4 mb-6">
          <div className="h-px w-8 bg-gradient-to-r from-brand-400 to-brand-600 mb-3 opacity-50" />
        ...
        <button className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-bg-hover transition-colors text-text-light hover:text-text-main border border-transparent">
